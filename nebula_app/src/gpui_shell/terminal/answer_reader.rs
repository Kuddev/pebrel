        ...
        let mut root = v_flex()
            ...
            .child(
                h_flex()
                    ...
                    .child(div().text_sm().flex_1().child(
                        language.format(Message::AnswerLatestAnswer, &[("provider", provider)]),
                    ))
                    .child(
            ...
            .when(self.preparing, |root| {
                root.child(
                    div()
                        ...
                        .text_sm()
                        .text_color(muted)
                        .child(language.text(Message::AnswerPreparing)),
                )
            })
            .child(
            ...
            root = root.child(
                v_flex()
                    ...
                    .child(
                        h_flex()
                            .justify_between()
                            .child(language.text(Message::AnswerImagePreview))
                            .child(
