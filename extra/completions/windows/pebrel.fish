...
complete -c pebrel -n "__fish_pebrel_needs_command" -f -a "mobile-bridge" -d 'Serve the bounded mobile control protocol over an authenticated SSH exec channel. Does not open a network listener or print the local runtime token'
...
complete -c pebrel -n "__fish_pebrel_using_subcommand mobile-bridge" -l allow-input -d 'Explicitly allow prompt and named-key requests for this SSH channel'
complete -c pebrel -n "__fish_pebrel_using_subcommand mobile-bridge" -s h -l help -d 'Print help'
...
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent mobile-bridge migrate config notify-test setup-ai ssh help" -f -a "window" -d 'Control terminal windows'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent mobile-bridge migrate config notify-test setup-ai ssh help" -f -a "tab" -d 'Control tabs within one terminal window'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent mobile-bridge migrate config notify-test setup-ai ssh help" -f -a "pane" -d 'Inspect and drive terminal panes: list, read, send, paste, wait, and change layout'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent mobile-bridge migrate config notify-test setup-ai ssh help" -f -a "agent" -d 'Inspect and drive the AI agents running in panes: list, send, read, wait'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent mobile-bridge migrate config notify-test setup-ai ssh help" -f -a "mobile-bridge" -d 'Serve the bounded mobile control protocol over an authenticated SSH exec channel. Does not open a network listener or print the local runtime token'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent mobile-bridge migrate config notify-test setup-ai ssh help" -f -a "migrate" -d 'Migrate the configuration file'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent mobile-bridge migrate config notify-test setup-ai ssh help" -f -a "config" -d 'Validate or create the Pebrel configuration'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent mobile-bridge migrate config notify-test setup-ai ssh help" -f -a "notify-test" -d 'Test system notification (toast) delivery'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent mobile-bridge migrate config notify-test setup-ai ssh help" -f -a "setup-ai" -d 'Install (or --remove) AI hooks plus the Pebrel Runtime Skill for Codex and Claude Code'
...
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent mobile-bridge migrate config notify-test setup-ai ssh help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
