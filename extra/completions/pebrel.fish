...
function __fish_pebrel_global_optspecs
	string join \n print-events ref-test embed= gpui config-file= socket= q v daemon working-directory= shell= hold e/command= T/title= class= o/option= h/help V/version
end
...
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent migrate config help" -f -a "ctl" -d 'Agent-oriented terminal control: split panes, run commands, start Codex/Claude, send prompts, wait for state changes, and read verified terminal output'
...
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent migrate config help" -f -a "window" -d 'Control terminal windows'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent migrate config help" -f -a "tab" -d 'Control tabs within one terminal window'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent migrate config help" -f -a "pane" -d 'Inspect and drive terminal panes: list, read, send, paste, wait, and change layout'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent migrate config help" -f -a "agent" -d 'Inspect and drive the AI agents running in panes: list, send, read, wait'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent migrate config help" -f -a "migrate" -d 'Migrate the configuration file'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent migrate config help" -f -a "config" -d 'Validate or create the Pebrel configuration'
complete -c pebrel -n "__fish_pebrel_using_subcommand help; and not __fish_seen_subcommand_from ctl env window tab pane agent migrate config help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
