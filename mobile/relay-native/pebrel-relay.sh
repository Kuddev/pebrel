...
export PATH
release_base='https://github.com/Kuddev/pebrel/releases/download/relay-300f5e7b9d14'
...
case "$(uname -m)" in
    x86_64) arch=x86_64; expected='e7469213f9ea0707cdbd534580f49dbbb7269563cfc131ffbdb77cd036fb52ad';;
    aarch64|arm64) arch=aarch64; expected='a11f55204fff9c2ee01778f901a2acd3da7e0782d445a430d8aaa9e5473fbe3b';;
