                ...
                when (route) {
                    ...
                    "desktop" -> {
                        DesktopScreen(
                            desktop = desktop,
                            onBack = ::back,
                            onPane = { openPane(desktopId, it) },
                            onCreateTab = { window -> repository.createDesktopTab(desktopId, window) },
                            onCloseTab = { tab, confirmed -> repository.closeDesktopTab(desktopId, tab, confirmed) },
                            onDisconnect = { repository.closeDesktop(desktopId); back() },
                        )
                    }
                    else -> {
